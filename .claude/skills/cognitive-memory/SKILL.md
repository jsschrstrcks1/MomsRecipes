...
```bash
python3 /home/user/.memory/memory_ops.py recall "" --scope /recipes/mommom --limit 10
python3 /home/user/.memory/memory_ops.py tree /recipes/mommom
```
...
```bash
python3 /home/user/.memory/memory_ops.py recall "QUERY" --scope /recipes/mommom
```
...
```bash
python3 /home/user/.memory/memory_ops.py forget --scope /recipes/mommom --older-than 90 --dry-run
python3 /home/user/.memory/memory_ops.py forget --scope /recipes/mommom --older-than 90
```
