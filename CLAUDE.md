...
3. `/home/user/open-claw-stuff` — the path recorded when this file was generated. Correct on that machine only,
...
```bash
node <OCS>/admin/library.mjs preflight --query "<task>" --patron claude-code --merge --repo MomsRecipes
```
